...
const Add_New_User = async (e) => {
    ...
    e.preventDefault();
    try {
      const resp = await Axios.post(`http://3.122.234.138/:3001/backend/user/register`, {
        ref:formValue.ref,
        name: formValue.name,
          ...
          <form class="needs-validation mb-5" novalidate>
            <div class="row">
              ...
              <div class="col-12">
                ...
                <div class="mb-3">
                  <label for="studyname" id="studynameLabel" class="form-label is-required">Full name</label>
                  <input type="text"
                   class="form-control" 
                    id="name"
                    name="name"
                ...
                <button type="submit" class="btn btn-primary mt-2" onClick={Add_New_User}>Sign Up</button>
              </div>
            </div>
          </form>
        </div>
